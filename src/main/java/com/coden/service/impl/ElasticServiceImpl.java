...
import com.coden.service.ElasticService;
...
public class ElasticServiceImpl implements ElasticService {
    ...
    public List<FileDocument> search(String keyword) throws IOException {
        ...
        while (iterator.hasNext()) {
            ...
            if (abstractString.length() > 150) {
                abstractString = abstractString.substring(0, 150);
            }
            ...
            if (sourceAsMap.containsKey("id")) {
                ...
                if (id != null && !idSet.contains(id)) {
                    ...
                    System.out.println("------命中的得分:" + score);
                    fileDocument.setScore(score);
                    System.out.println(fileDocument.getScore());
